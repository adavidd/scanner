...
import co.il.scanner.databinding.ActivityMainBinding;
...
import co.il.scanner.utility.Device;
import io.reactivex.Observer;
import io.reactivex.annotations.NonNull;
import io.reactivex.disposables.Disposable;

import static co.il.scanner.Constants.INITIAL_USER_STATE;
...
//                            Log.d("chaim", "cartBarcode after substing 1 " + cartbarcodeStr);
                        cartbarcodeStr = cartbarcodeStr.substring(9);
//                            Log.d("chaim", "cartBarcode after substing 2 " + cartbarcodeStr);
//                            Log.d("chaim", "cart number barcode is: " + cartbarcodeStr + " id is: " + Integer.parseInt(cartbarcodeStr));
